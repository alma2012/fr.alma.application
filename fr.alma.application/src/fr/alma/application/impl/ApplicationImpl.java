 ...
 * <ul>
 *   <li>{@link fr.alma.application.impl.ApplicationImpl#getModels <em>Models</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ApplicationImpl extends EObjectImpl implements Application {
	 ...
	 * @ordered
	 */
	protected EList<ObeoDSMObject> models;
	 ...
	 * @generated
	 */
	public EList<ObeoDSMObject> getModels() {
		if (models == null) {
			models = new EObjectResolvingEList<ObeoDSMObject>(ObeoDSMObject.class, this, ApplicationPackage.APPLICATION__MODELS);
		}
		return models;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ApplicationPackage.APPLICATION__MODELS:
				getModels().clear();
				getModels().addAll((Collection<? extends ObeoDSMObject>)newValue);
				return;
		}
